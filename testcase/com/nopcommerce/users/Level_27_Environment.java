...
import ultilities.EnvironmentConfig;
import ultilities.ExcelConfig;
import ultilities.PropertiesConfig;

@Feature("User")
public class Level_27_Environment extends BaseTest {
    String browserName;
    private String userUrlValue, adminUrlValue;
    EnvironmentConfig environmentConfig;

    public Level_27_Environment() {
        super();
    }
...
//        prop = PropertiesConfig.getProperties(environment);
//        driver = getBrowserDriver(browserName,prop.getApplicationUrl());
//        System.out.println(prop.getApplicationUserName());
//        System.out.println(prop.getApplicationUserName());
