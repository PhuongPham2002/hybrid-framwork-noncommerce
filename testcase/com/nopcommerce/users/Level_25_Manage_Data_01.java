...
public class Level_25_Manage_Data_01 extends BaseTest {
    ...
    @Parameters({"url","browser","firstname","lastname","editfirstname","editlastName","driverlicense","expirydate"})
    @BeforeClass
    public void beforeClass(String urlValue,String browserName,String firstName, String lastName, String editFirstname, String editLastName,String driverLicense, String expiryDate) {
