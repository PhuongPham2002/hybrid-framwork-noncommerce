...
public class Level_25_Manage_Data_05_JSON_OBJECT extends BaseTest {
    ...
    public void beforeClass(String urlValue,String browserName) {
        ...
        System.out.println("Name: " + employeeData.getPosition());
        System.out.println("Name: " + employeeData.getAddress().getStreet());
        System.out.println("Name: " + employeeData.getAddress().getStreetNumber());

        System.out.println("Name: " + employeeData.getSkillTree().get(0));
        System.out.println("Name: " + employeeData.getSkillTree().get(1));
        System.out.println("Name: " + employeeData.getSkillTree().get(2));
        List<String> skillList = employeeData.getSkillTree();
        for (int i=0;i<skillList.size();i++){
            System.out.println("Skill: "+employeeData.getSkillTree().get(i));
        }
